...
public class UnityEngine_ParticleSystemWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("__tostring", LuaInterface.ToLua.op_ToString);
	...
	static int _CreateUnityEngine_ParticleSystem(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				...
				LuaInterface.ToLua.PushSealed(L, obj);
				return 1;
			}
			else
			{
	...
	static int SetParticles(IntPtr L)
	{
		try
		{
			...
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)LuaInterface.ToLua.CheckObject(L, 1, typeof(UnityEngine.ParticleSystem));
	...
	static int SetCustomParticleData(IntPtr L)
	{
		try
		{
			LuaInterface.ToLua.CheckArgsCount(L, 3);
			UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)LuaInterface.ToLua.CheckObject(L, 1, typeof(UnityEngine.ParticleSystem));
			System.Collections.Generic.List<UnityEngine.Vector4> arg0 = (System.Collections.Generic.List<UnityEngine.Vector4>)LuaInterface.ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.List<UnityEngine.Vector4>));
			UnityEngine.ParticleSystemCustomData arg1 = (UnityEngine.ParticleSystemCustomData)LuaInterface.ToLua.CheckObject(L, 3, typeof(UnityEngine.ParticleSystemCustomData));
	...
	static int GetPlaybackState(IntPtr L)
	{
		try
		{
			LuaInterface.ToLua.CheckArgsCount(L, 1);
			UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)LuaInterface.ToLua.CheckObject(L, 1, typeof(UnityEngine.ParticleSystem));
			UnityEngine.ParticleSystem.PlaybackState o = obj.GetPlaybackState();
			LuaInterface.ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int SetPlaybackState(IntPtr L)
	{
		try
		{
			LuaInterface.ToLua.CheckArgsCount(L, 2);
			UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)LuaInterface.ToLua.CheckObject(L, 1, typeof(UnityEngine.ParticleSystem));
	...
	static int GetTrails(IntPtr L)
	{
		try
		{
			...
			else if (count == 2)
			{
				...
				LuaDLL.lua_pushinteger(L, o);
				LuaInterface.ToLua.PushValue(L, arg0);
				return 2;
			}
			else
			{
	...
	static int Stop(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)LuaInterface.ToLua.CheckObject(L, 1, typeof(UnityEngine.ParticleSystem));
				bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
				UnityEngine.ParticleSystemStopBehavior arg1 = (UnityEngine.ParticleSystemStopBehavior)LuaInterface.ToLua.CheckObject(L, 3, typeof(UnityEngine.ParticleSystemStopBehavior));
				obj.Stop(arg0, arg1);
				return 0;
			}
			else
	...
	static int TriggerSubEmitter(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<UnityEngine.ParticleSystem.Particle>(L, 3))
			{
				...
				LuaInterface.ToLua.PushValue(L, arg1);
				return 1;
			}
			else if (count == 3 && TypeChecker.CheckTypes<System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>>(L, 3))
			{
				UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)LuaInterface.ToLua.CheckObject(L, 1, typeof(UnityEngine.ParticleSystem));
				int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
				System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> arg1 = (System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>)LuaInterface.ToLua.ToObject(L, 3);
	...
	static int ResetPreMappedBufferMemory(IntPtr L)
	{
		try
		{
			LuaInterface.ToLua.CheckArgsCount(L, 0);
	...
	static int AllocateCustomDataAttribute(IntPtr L)
	{
		try
		{
			LuaInterface.ToLua.CheckArgsCount(L, 2);
			UnityEngine.ParticleSystem obj = (UnityEngine.ParticleSystem)LuaInterface.ToLua.CheckObject(L, 1, typeof(UnityEngine.ParticleSystem));
			UnityEngine.ParticleSystemCustomData arg0 = (UnityEngine.ParticleSystemCustomData)LuaInterface.ToLua.CheckObject(L, 2, typeof(UnityEngine.ParticleSystemCustomData));
	...
	static int op_Equality(IntPtr L)
	{
		...
		{
			LuaInterface.ToLua.CheckArgsCount(L, 2);
			UnityEngine.Object arg0 = (UnityEngine.Object)LuaInterface.ToLua.ToObject(L, 1);
			UnityEngine.Object arg1 = (UnityEngine.Object)LuaInterface.ToLua.ToObject(L, 2);
			bool o = arg0 == arg1;
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
	...
	static int get_isPlaying(IntPtr L)
	{
		...
		try
		{
			o = LuaInterface.ToLua.ToObject(L, 1);
	...
	static int get_main(IntPtr L)
	{
		...
		try
		{
			...
			LuaInterface.ToLua.PushValue(L, ret);
			return 1;
		}
		catch(Exception e)
		{
